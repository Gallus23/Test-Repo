...
$csvfolder = "d:\software\scripts\CSV-Files"
...
$getdsva | Export-Csv "$csvfolder\$Location-dsva.csv" -NoTypeInformation
...
$gettemp | Export-Csv "$csvfolder\$Location-tempedge.csv" -NoTypeInformation
$gettemp = $gettemp | ConvertTo-Html -Fragment

#--------------------------------------------------------------------------------------------------------------------------------------
#Graphs from PTRG 

$reportptrggraph = "<div id='boxheader'>Ping graph for $Location Stats for the last 2 days </p> </div>"

switch ($Location.ToLower())
    {
    "au1" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2139&mapid=AA730E65-1ECA-413C-92FA-9000A5232ECA'>   </iframe>"}
    "bj1" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2140&mapid=9879AD06-A2BF-4320-A186-69EAE09DCA65'>   </iframe>"}
    "bz1" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2141&mapid=B204597A-07B7-448B-A967-39A0F99F1ABF'>   </iframe>"}
    "icd" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2142&mapid=AE2BCF81-FF30-4338-AA5C-9E42FF6C6043'>   </iframe>"}
    "lo1" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2143&mapid=D2A20ABA-B8CE-47BF-A9A8-3FF6FDB29FF4'>   </iframe>"}
    "nj2" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2145&mapid=EB68AE14-AD1E-46E3-BB00-B2BD029388FE'>   </iframe>"}
    "sg8" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2146&mapid=B7B60915-70BC-4EE4-815D-348F2AC5D593'>   </iframe>"}
    "sh1" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2147&mapid=120A57A4-05EA-4085-A510-502FB55EEA0F'>   </iframe>"}
    "lo3" {$getptrggraph = "<iframe width=800 height=480 frameborder='1'   src='http://10.76.192.11/public/mapshow.htm?id=2144&mapid=1B36A9F6-79EE-4064-A13A-8E3AFE884647'>   </iframe>"}
    }
...
$allhosts | Select HostName,status, ConnectionState, @{Name = 'Max_Mem_%'; Expression = {"{0:N2}" -f $_.MemMax}} , @{Name = 'Ave_Mem_%'; Expression = {"{0:N2}" -f $_.MemAvg}}, @{Name = 'Max_CPU_%'; Expression = {"{0:N2}" -f $_.CPUMax}}, @{Name = 'Ave_CPU_%'; Expression = {"{0:N2}" -f $_.CPUAvg}} | sort-object hostname | export-csv "$csvfolder\$Location-hosts.csv" -NoTypeInformation
...
$datastores | select-object Name, status, CapacityGB, @{Name = 'FreeGB'; Expression = {"{0:N2}" -f $_.FreeSpaceGB}}, PercentFree | Sort-Object PercentFree  | Export-Csv "$csvfolder\$Location-datastores.csv" -NoTypeInformation
...
$htmlbody = "$br $reportptrggraph  $BoxContentOpener $getptrggraph  $PageBoxCloser "
